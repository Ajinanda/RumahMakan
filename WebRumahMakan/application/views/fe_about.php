                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="about-images">
                            <img class="about-main" src="<?php echo base_url('assets/images/about-main.jpg'); ?>" alt="About Main Image">
                            <img class="about-inset" src="<?php echo base_url('assets/images/about-inset.jpg'); ?>" alt="About Inset Image">
                        </div>
                    </div>
                </div>
                <!-- end col -->
