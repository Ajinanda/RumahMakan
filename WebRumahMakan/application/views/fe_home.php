                    ...
                    <div class="special-box">
                        <div id="owl-demo">
                            <div class="item item-type-zoom">
                                ...
                                <div class="item-img">
                                    <img src="<?php echo base_url('assets/images/special-menu-1.jpg'); ?>" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                ...
                                <div class="item-img">
                                    <img src="<?php echo base_url('assets/images/special-menu-2.jpg'); ?>" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                ...
                                <div class="item-img">
                                    <img src="<?php echo base_url('assets/images/special-menu-3.jpg'); ?>" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
